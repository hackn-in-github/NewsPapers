...
\begin{tikzpicture}[font=\Huge,yscale=1,>={Stealth[length=4mm]}]
 ...
 \node(仲町12)at(0,0)[e]{仲町1・2丁目[読売44部(金・土・日読売$+1$)]};
 \node(仲町3)at(0,-1)[e]{仲町3丁目[読売17部(土・日報知$+1$)]};
 \node(東町)at(0,-2)[e]{東町[読売16部]};
 ...
 \draw[->,very thick]($(後仲町2-|O1)+(0,.2)$)--($(後仲町2.east)+(0,.2)$)node[FN,pos=.5,fill=white]{読14};
 ...
 \draw[->,dash dot,very thick](東町.east)--(東町-|O3)--($(後東町-|O3)+(0,.2)$)--($(後東町.east)+(0,.2)$)node[pos=.5,FN,fill=white]{読16};
