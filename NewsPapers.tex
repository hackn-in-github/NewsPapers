...
\begin{tikzpicture}[font=\Huge,yscale=1,>={Stealth[length=4mm]}]
 ...
 \node(本町2)at(0,-5)[e]{本町2丁目[読売21部・報知1部]};
 %
 ...
 \node(後本町2)at(0,-12)[e]{組換後：本町2丁目[読売21部・報知1部]};
 %
 ...
 \draw[->,thick,dash dot dot](本町2.east)--(本町2-|O6)--(後本町2-|O6)--(後本町2.east)node[pos=.5,FN,fill=white]{読21報1};
\end{tikzpicture}
\end{document}