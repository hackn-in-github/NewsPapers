...
\begin{tikzpicture}[font=\Huge,yscale=1,>={Stealth[length=4mm]}]
 ...
 \draw[->](仲町3.east)--(仲町3-|O2)--(後仲町3-|O2)--(後仲町3.east)node[pos=.5,FN,fill=white]{読16報$+1$};
 ...
 \draw[->,dotted,very thick](柏台.east)--(柏台-|O4)--($(後東町-|O4)+(0,-.2)$)--($(後東町.east)+(0,-.2)$)node[pos=.5,FN,fill=white]{読6};
