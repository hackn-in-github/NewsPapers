...
\begin{tikzpicture}[font=\Huge,yscale=1,>={Stealth[length=4mm]}]
 ...
 \node(仲町12)at(0,0)[e]{仲町1・2丁目[読売47部(金・土・日読売$+1$)]};
 \node(仲町3)at(0,-1)[e]{仲町3丁目[読売17部(土・日報知$+1$)]};
 \node(東町)at(0,-2)[e]{東町[読売17部]};
 \node(柏台)at(0,-3)[e]{柏台[読売5部]};
 \node(本町1)at(0,-4)[e]{本町1丁目[読売16部・報知1部(土・日・月読売$+1$)]};
 \node(本町2)at(0,-5)[e]{本町2丁目[読売25部・報知1部]};
 %
 \node(後仲町2)at(0,-7)[e]{組換後：仲町2丁目[読売16部]};
 \node(後仲町3)at(0,-8)[e]{組換後：仲町3丁目[読売18部(土・日報知$+1$)]};
 \node(後東町)at(0,-9)[e]{組換後：東町[読売20部]};
 \node(後仲町12)at(0,-10)[e]{組換後：仲町1・2丁目[読売32部(金・土・日読売$+1$)]};
 \node(後本町1)at(0,-11)[e]{組換後：本町1丁目[読売16部・報知1部(土・日・月読売$+1$)]};
 ...
 \draw[->,dash dot,very thick](東町.east)--(東町-|O3)--($(後東町-|O3)+(0,.2)$)--($(後東町.east)+(0,.2)$)node[pos=.5,FN,fill=white]{読17};
 ...
 \draw[->,thick](本町1.east)--(本町1-|O5)--(後本町1-|O5)node[e,FN]{読$16+1$報1}--(後本町1.east);
