...
\begin{tikzpicture}[font=\Huge,yscale=1,>={Stealth[length=4mm]}]
 ...
 \draw[->,dash dot,very thick](東町.east)--(東町-|O3)--($(後東町-|O3)+(0,.2)$)--($(後東町.east)+(0,.2)$)node[pos=.5,FN,fill=white]{読14};
 ...
 \draw[->,thick](本町1.east)--(本町1-|O5)--(後本町1-|O5)node[e,FN]{読$13+1$報1}--(後本町1.east);
